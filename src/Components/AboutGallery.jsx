    ...
    <div className="bg-white font-helvetica p-6 mt-10 md:px-36">
      <div>
          <div className="md:mt-24">
            <p className="font-adobe text-[#6D4E56] text-3xl font-semibold italic md:text-5xl md:text-center">About the gallery</p>
            <p className="mt-8 text-[#424F47] text-base">
            ...
            <p className="mt-10 text-[#424F47] text-base">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center md:gap-12 md:mt-32 md:mb-24">
              <div className="mt-8">
                <p className="font-adobe text-[#6D4E56] text-3xl font-semibold italic md:text-5xl md:text-center">Our Mission</p>
                <p className="mt-3 text-[#424F47] text-base">
              ...
              <div className="mt-5">
                <p className="font-adobe text-[#6D4E56] text-3xl font-semibold italic md:text-5xl md:text-center">Our Vision</p>
                <p className="mt-3 text-[#424F47] text-base">
