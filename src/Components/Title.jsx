...
const Title = () => {
  return (
    <div className='flex flex-col mt-[101px] px-6 text-white font-helvetica space-y-3 md:flex-row md:justify-center md:gap-12 md:items-center md:px-32 md:space-y-0 '>
      <img src={mainLogo} alt="" className='mx-auto md:mx-0' />
      
      <img src={demarcation} alt="" className='hidden md:block'/>

      <div className="flex flex-col p-[43px] space-y-3 md:space-y-8">
        <div className='flex flex-col justify-center items-center px-6 md:justify-start md:items-start md:space-y-5'>
          <p className='text-2xl text-center font-atiba font-semibold uppercase md:hidden'>run through <br /> walls</p>
          <p className='hidden text-2xl text-center font-atiba font-semibold uppercase md:block md:text-start md:text-5xl'>run through walls</p>
